...
* Rating bar: http://abhiandroid.com/ui/ratingbar
* Flip animation: http://abhiandroid.com/ui/viewflipper
* Flipper: https://developer.android.com/reference/android/widget/ViewFlipper.html
* To display toast: http://stackoverflow.com/questions/2506876/how-to-change-position-of-toast-in-android
* Stop animation: http://stackoverflow.com/questions/12610106/how-to-stop-android-viewflipper-from-looping
* */
...
public class MainActivity extends AppCompatActivity {
    ...
    public void buildCopingDeck(View view) {
        ...
        //Obtain feeling from spinner
        Spinner moodSpinner = (Spinner) findViewById(R.id.listCurrentFeelings);
        String feelingValue = String.valueOf(moodSpinner.getSelectedItem());

        //Obtain rating bar information and send to Firebase database
        RatingBar feelingRating = (RatingBar) findViewById(R.id.ratingBar);
        Float ratingNumber = feelingRating.getRating();

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("Feeling Before");

        myRef.setValue(ratingNumber);

        //Set up intent
        Intent intent = new Intent(this, Main2Activity.class);
        intent.putExtra("userDeck", userDeck);
        intent.putExtra("userFeeling", feelingValue);
